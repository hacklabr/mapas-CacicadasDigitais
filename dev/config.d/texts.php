...
return [
    ...
    "text:home-entities.projects" => i::__("Este é o espaço onde você pode descobrir projetos que estão acontecendo na Resex! Explore, conecte-se e conte o quanto é importante o que acontece por aqui."),
    "text:home-entities.spaces" => i::__("Procure por lugares que realizam atividades ou ações. Você também pode cadastrar os lugares onde desenvolve suas atividades."),
    "text:home-feature.description" => i::__("Confira os últimos destaques de cada uma das áreas."),
    "text:home-register.description" => i::__("Faça seu cadastro e colabore com o Mapa Cacicadas Digitais. Participe desta plataforma livre, colaborativa e interativa de mapeamento na Resex Tapajós-Arapiuns. Esta é uma ferramenta de governança territorial. Se você é de uma Resex ou apoia e contribui com essas comunidades, cadastre-se!"),
];
