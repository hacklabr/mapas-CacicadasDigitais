...
$items = array(
    ...
    26 => array( 'name' => \MapasCulturais\i::__("Conferência Pública")),
    27 => array( 'name' => \MapasCulturais\i::__("Conferência Territorial")),
    28 => array( 'name' => \MapasCulturais\i::__("Assembléia")),
   // 29 => array( 'name' => \MapasCulturais\i::__("Conferência Pública Municipal")),
    ...
    8 =>  array( 'name' => \MapasCulturais\i::__("Programa de formação")),
...
//        34 => array( 'name' => \MapasCulturais\i::__("Parada e Desfile de Ações Afirmativas")),
   ...
   // 40 => array( 'name' => \MapasCulturais\i::__("Abaixo-assinado")),
    ...
    46 => array( 'name' => \MapasCulturais\i::__("Fomento")),
    47 => array( 'name' => \MapasCulturais\i::__("Bolsa/Auxílio")),
);
